  ...
  return [
    {
      ...
      airDay: 'Monday',
      nextAirDate: '2025-07-14T00:31:00',
    },
    {
      anime: getAnime('oceans-whisper')!,
      nextEpisode: lastEp('oceans-whisper'),
      airDay: 'Monday',
      nextAirDate: '2025-07-14T03:44:00',
    },
    {
      anime: getAnime('blade-of-the-fallen')!,
      nextEpisode: lastEp('blade-of-the-fallen'),
      airDay: 'Tuesday',
      nextAirDate: '2025-07-15T06:03:00',
    },
    {
      anime: getAnime('after-school-skies')!,
      nextEpisode: lastEp('after-school-skies'),
      airDay: 'Tuesday',
      nextAirDate: '2025-07-15T13:41:00',
    },
    {
      anime: getAnime('spirit-veil')!,
      nextEpisode: lastEp('spirit-veil'),
      airDay: 'Wednesday',
      nextAirDate: '2025-07-16T04:37:00',
    },
    {
      anime: getAnime('crimson-vow')!,
      nextEpisode: lastEp('crimson-vow'),
      airDay: 'Wednesday',
      nextAirDate: '2025-07-16T14:12:00',
    },
    {
      anime: getAnime('neon-orbit')!,
      nextEpisode: lastEp('neon-orbit'),
      airDay: 'Thursday',
      nextAirDate: '2025-07-17T04:09:00',
    },
    {
      anime: getAnime('hollow-kingdom')!,
      nextEpisode: lastEp('hollow-kingdom'),
      airDay: 'Thursday',
      nextAirDate: '2025-07-17T14:42:00',
    },
    {
      anime: getAnime('starfall-academy')!,
      nextEpisode: lastEp('starfall-academy'),
      airDay: 'Friday',
      nextAirDate: '2025-07-18T15:38:00',
    },
    {
      anime: getAnime('letter-to-spring')!,
      nextEpisode: lastEp('letter-to-spring'),
      airDay: 'Friday',
      nextAirDate: '2025-07-18T16:08:00',
    },
    {
      anime: getAnime('eternal-frost')!,
      nextEpisode: lastEp('eternal-frost'),
      airDay: 'Saturday',
      nextAirDate: '2025-07-19T03:03:00',
    },
    {
      anime: getAnime('crimson-blade')!,
      nextEpisode: lastEp('crimson-blade'),
      airDay: 'Saturday',
      nextAirDate: '2025-07-19T12:39:00',
    },
    {
      anime: getAnime('last-serve')!,
      nextEpisode: lastEp('last-serve'),
      airDay: 'Sunday',
      nextAirDate: '2025-07-20T01:13:00',
    },
    {
      anime: getAnime('thunder-league')!,
      nextEpisode: lastEp('thunder-league'),
      airDay: 'Sunday',
      nextAirDate: '2025-07-20T09:10:00',
    },
  ]
}
