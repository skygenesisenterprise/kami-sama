...
import { getNewWorks } from '@/lib/mock-library'
  ...
  return (
    <div className="min-h-screen bg-[#141414] pb-16 text-white">
      <div className="mx-auto max-w-screen-7xl px-4 pt-8 md:px-8">
        <h1 className="text-2xl font-bold tracking-tight text-white md:text-3xl">{t('navNew')}</h1>
        <p className="mt-1 text-sm text-white/50">{t('newArrivalsSub')}</p>
