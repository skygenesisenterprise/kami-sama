  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button variant="outline" size="lg" className="h-11" onClick={() => handleOAuthLogin('google')}>
          <GoogleIcon className="size-4" />
          Google
        </Button>
        <Button variant="outline" size="lg" className="h-11" onClick={() => handleOAuthLogin('discord')}>
          <DiscordIcon className="size-4" />
          Discord
        </Button>
        <Button variant="outline" size="lg" className="h-11" onClick={() => handleOAuthLogin('github')}>
          <GithubIcon className="size-4" />
          GitHub
        </Button>
        <Button variant="outline" size="lg" className="h-11" onClick={() => handleOAuthLogin('apple')}>
